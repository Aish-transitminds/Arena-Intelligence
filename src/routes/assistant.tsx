...
export const Route = createFileRoute("/assistant")({
  head: () => ({
    meta: [
      { title: "GenAI Operations Copilot — Arena Intelligence" },
...
function Assistant() {
  ...
  return (
    <AppShell title="GenAI Copilot Workspace" subtitle="Multimodal neural model trained on MetLife Stadium events and telemetry data">
          ...
          <div className="p-4 border-t border-white/5" style={{ background: "rgba(7,20,28,0.30)" }}>
            ...
            >
              <input
                ...
                placeholder={`Query GenAI Copilot about crowds, queues, transport or guidelines as ${persona}...`}
