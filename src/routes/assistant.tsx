...
export const Route = createFileRoute("/assistant")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Cricket match day operations intelligence assistant at Narendra Modi Stadium. Persona-driven real-time coordination." },
    ],
  }),
  component: Assistant,
});
...
function buildSystemPrompt(persona: Persona, lang: Language) {
  ...
  return `You are Arena IQ, the intelligent operations assistant for Narendra Modi Stadium during the 2026 ICC Men's T20 World Cup.
...
function Assistant() {
  ...
  const [messages, setMessages] = useState<{ role: "user" | "ai"; text: string }[]>([
    { role: "ai", text: "Welcome to Narendra Modi Stadium ICC T20 World Cup 2026 Arena IQ. Select your persona in the tabs and preferred language in the header to coordinate real-time crowd dynamics." },
  ]);
  ...
  return (
    <AppShell title="Arena IQ Workspace" subtitle="Multimodal neural model trained on Narendra Modi Stadium events and telemetry data">
