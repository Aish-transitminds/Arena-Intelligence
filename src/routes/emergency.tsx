            ...
            <div className="grid md:grid-cols-2 gap-8 items-stretch">
              ...
              <div className="flex flex-col items-center justify-center p-6 rounded-2xl border" style={{ background: "rgba(255,255,255,0.01)", borderColor: "rgba(0,0,0,0.04)" }}>
                ...
                <motion.button
                  ...
                  disabled={sos}
                  className="size-36 rounded-full flex flex-col items-center justify-center font-extrabold text-slate-900 cursor-pointer disabled:cursor-not-allowed relative"
                  style={{
                    background: sos
              ...
              <form onSubmit={handleAreaSos} className="flex flex-col text-left p-6 rounded-2xl border" style={{ background: "rgba(255,255,255,0.01)", borderColor: "rgba(0,0,0,0.04)" }}>
                ...
                <button
                  type="submit"
                  className="w-full py-2.5 mt-5 rounded-xl text-xs font-bold uppercase tracking-wider text-slate-900 hover:opacity-90 active:scale-95 transition cursor-pointer"
...
function ResponseCard({
  ...
  return (
    ...
    >
      ...
      <div className="text-3xl font-extrabold text-slate-900 tracking-tight tabular-nums">{count}</div>
    </div>
  );
}
