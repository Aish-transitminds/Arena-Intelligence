    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center glass-strong rounded-3xl p-10">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          This route doesn't exist in the stadium.
        </p>
        <div className="mt-6">
          <Link to="/" className="inline-flex items-center justify-center rounded-lg px-4 py-2 text-sm font-medium text-primary-foreground"
    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center glass-strong rounded-3xl p-10">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="rounded-lg border border-border glass px-4 py-2 text-sm font-medium">Go home</a>
        </div>
      </div>
    </div>
  );
